                ...
                <div class="card">
                    ...
                    <form action="{{ route('search') }}" method="GET">
                        ...
                        <div class="col-md-12 d-flex justify-flex-start justify-content-space-between align-items-center ">
                            <div  style="display: flex; align-items: center; height: fit-content; margin-right: 10px; width: 100%;">
                              ...
                              <div style="display: flex; align-items: center; height: fit-content; margin-right: 10px; width: 100%;">
                                <h5 class="card-header" style="font-size: 16px;">Pilih tanggal</h5>
                                <input
                                  type="text"
                                  name="time"
                                  class="form-control"
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @empty
                            <h5 class="card-header d-flex justify-content-center" style="font-size: 16px; width: 100%;">artikel tidak ditemukan</h5>
                            @endforelse
                        </tbody>
                    </table>
                    </div>
