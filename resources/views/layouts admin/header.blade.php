<meta charset="utf-8" />
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets admin/assets/') }}/img/favicon/polindra.png" />
    ...
    <link rel="stylesheet" href="{{ asset('assets admin/assets/') }}/vendor/libs/swiper/swiper.css" />
    <link rel="stylesheet" href="{{ asset('assets admin/assets/') }}/vendor/libs/datatables-bs5/datatables.bootstrap5.css" />
    <link rel="stylesheet" href="{{ asset('assets admin/assets/') }}/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css" />
    <link rel="stylesheet" href="{{ asset('assets admin/assets/') }}/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css" />
