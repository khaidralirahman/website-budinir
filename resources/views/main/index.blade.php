...
<body class="home-page-1">
    ...
    <main>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <h1 class="entry-title mb-20 fw-700">
                        Selamat Datang di Website BudiNir
                    </h1>
        ...
        <section class="trending pt-65 pb-65 position-relative">
            ...
            <div class="container">
                <h3 class="mb-65 font-heading wow fadeIn animated">Trending Artikel</h3>
                <div class="row">
                            ...
                            <div class="post-card-1 border-radius-10 hover-up">
                                ...
                                <div class="post-content p-30">
                                    <div class="post-card-content">
                                        ...
                                        <div class="post-excerpt text-grey-400">
                                            {{ substr(strip_tags($item->description), 0, 30) }}{{ strlen(strip_tags($item->description)) > 30 ? '...' : '' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
